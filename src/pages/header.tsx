        ...
        <>
            <div className='fixed top-6 right-7 z-50 cursor-pointer group'
                ...
                <div className={`flex flex-col justify-center items-center w-6 h-8 gap-[0.3rem] transition-transform group-hover:rotate-[90deg]
                    ...
                    ></div>
                    <div
                        className={`h-1 w-full rounded-3xl bg-_green transition-opacity group-hover:opacity-0
                            ${menuOpen ? 'opacity-0' : '' } `}
                    ></div>
                    <div
                        className={`h-1 w-full rounded-3xl bg-white transition-transform 
            ...
            {menuOpen && (
                <div className='fixed top-0 left-0 w-full h-full flex justify-center items-center bg-_green transition-all duration-300 z-40'
                >
